...
Original file is located at
    https://colab.research.google.com/drive/1LpskPtj7nZ2u_riRKKkUPqcfsf4ZbKAk
"""
...
class MarkovChain:
    ...
    def predict(self, current_state):
        ...
        if total_transitions == 0:
            # Fallback if there are no transitions recorded
            return random.choice(['rock', 'paper', 'scissors'])

        r = random.random() * total_transitions
        for next_state, count in next_states.items():  # Fixed typo here
            r -= count
            if r <= 0:
                return next_state
